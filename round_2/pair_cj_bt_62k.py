...
class Trader:
    ...
    def save_prices_2(self, state: TradingState):
        ...
        spread_value = price_jams - 3.126 * price_croissants
    ...
    #     if abs(croissants_position) < POSITION_LIMITS[CROISSANTS] - 5:
    ...
    def pair_strategy_2(self, state: TradingState):
        ...
        ORDER_VOLUME = 4
        if abs(croissants_position) < POSITION_LIMITS[CROISSANTS] - 12:
        # if croissants_position <= 0:
            if spread_short < avg_spread - threshold*std_spread:
                orders_croissants.append(Order(CROISSANTS, int_price_croissants-price_adj, -ORDER_VOLUME))
                orders_jams.append(Order(DJEMBES, int_price_jams+price_adj, ORDER_VOLUME//4))
