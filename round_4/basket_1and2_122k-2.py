...
class Trader:
    def __init__(self, params=None):
        ...
        self.df_data : Dict[Product, List] = {
    ...
    def run(self, state: TradingState):
        ...
        #     for product, orders_list in spread_orders.items():
        # # If the result dictionary already has orders for this product (maybe from another strategy)
        #         if product in result:
        #             # Append the new orders for this product to the existing list
        #             result[product].extend(orders_list)
        #         else:
        #             # Otherwise, add the product and its list of orders to the result dictionary
        ...
        for i in state.observations.conversionObservations.keys():
            logger.print(i)
